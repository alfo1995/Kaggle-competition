...
+ **Data Tidying**:
  ...
  3. We made the imputation for the categorical variables where ‚ÄúNa‚Äù were occurred and then we created dummies variables.We         splitted again the whole dataset in Train and Test.
...
**GB** $\rightarrow$ (loss = ‘*huber*’, learning_rate = .05, n_estimators = 5000, max_depth = 1) 
